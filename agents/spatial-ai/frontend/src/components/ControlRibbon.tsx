...
/**
 * Full-width control ribbon: upload, grid mode, analyze, and session exports.
 * Same behaviour as the former Upload / Grid / Session panels — layout only.
 */
export function ControlRibbon() {
  ...
  const btn =
    "inline-flex items-center gap-1.5 rounded-lg border border-[var(--line)] px-3 py-2 text-xs font-medium transition disabled:cursor-not-allowed disabled:opacity-40";
  const btnPrimary =
    "inline-flex items-center gap-1.5 rounded-lg bg-ink-800 px-3 py-2 text-xs font-semibold text-white transition hover:bg-ink-700 disabled:cursor-not-allowed disabled:opacity-40 dark:bg-ink-200 dark:text-ink-950 dark:hover:bg-white";
  ...
  return (
    <section className="panel space-y-3 p-4">
      ...
      <div className="flex flex-wrap items-stretch gap-3">
        ...
        >
          <UploadCloud className="h-5 w-5 shrink-0 text-ink-500" />
          <div className="min-w-0">
            <p className="text-xs font-medium">Drag & Drop Upload</p>
        ...
        <label
          className={cn(
            ...
            gridMode === "automatic"
              ? "border-ink-800 bg-ink-800/5 dark:border-ink-200"
              : "border-[var(--line)]",
          )}
        >
          <input
        ...
        {gridMode === "manual" && (
          <div className="inline-flex items-center gap-2">
            <label
              ...
              className="text-[11px] uppercase tracking-wide text-[var(--muted)]"
            >
              Grid Size
            </label>
            <input
              ...
              className="w-20 rounded-lg border border-[var(--line)] bg-transparent px-2 py-1.5 text-xs outline-none focus:border-signal-info"
              placeholder="52"
            />
          </div>
        )}
