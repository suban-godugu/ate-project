"""RBAC extension point and bounded throttling for FA-FR-010."""
...
async def reporting_access_context(
    ...
    if role not in ALLOWED_ROLES:
        raise HTTPException(
            ...
            detail={
                ...
                "message": "Role is not permitted to access reporting APIs",
            },
        )
    return {"actor": (x_user_id or "system")[:128], "role": role}


async def reporting_rate_limit(request: Request) -> None:
