...
const tabs: { id: CostTab; label: string }[] = [
  ...
  { id: "scan-chain", label: "Scan Chain Cost" },
  { id: "mbist", label: "MBIST Cost" },
  { id: "lbist", label: "LBIST Cost" },
  { id: "wafer", label: "Wafer Cost" },
  { id: "ai-optimization", label: "AI Cost Optimization" },
];

export function CostTabs({ activeTab, onTabChange }: { activeTab: CostTab; onTabChange: (tab: CostTab) => void }) {
  return (
