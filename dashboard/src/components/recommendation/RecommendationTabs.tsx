...
const tabs: { id: RecommendationTab; label: string }[] = [
  ...
  { id: "scan-chain", label: "Scan Chain" },
  { id: "mbist", label: "MBIST" },
  { id: "lbist", label: "LBIST" },
  { id: "wafer", label: "Wafer Analysis" },
];

export function RecommendationTabs({ activeTab, onTabChange }: { activeTab: RecommendationTab; onTabChange: (tab: RecommendationTab) => void }) {
  return (
      ...
      {tabs.map((tab) => {
        ...
        return (
          ...
          >
            ...
            {isActive && (
              <motion.div
                layoutId="recommendation-tab-indicator"
