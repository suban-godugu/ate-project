...
const tabs: { id: AlertTab; label: string }[] = [
  ...
  { id: "scan-chain", label: "Scan Chain Alerts" },
  { id: "mbist", label: "MBIST Alerts" },
  { id: "lbist", label: "LBIST Alerts" },
  { id: "wafer", label: "Wafer Alerts" },
  { id: "cost", label: "Cost Alerts" },
  { id: "ai-recommendation", label: "AI Recommendation Alerts" },
];

export function AlertTabs({ activeTab, onTabChange }: { activeTab: AlertTab; onTabChange: (tab: AlertTab) => void }) {
  return (
