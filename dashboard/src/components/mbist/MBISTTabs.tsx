...
const tabs: { id: MbistTab; label: string }[] = [
...
export function MBISTTabs({ activeTab, onTabChange }: { activeTab: MbistTab; onTabChange: (tab: MbistTab) => void }) {
  return (
